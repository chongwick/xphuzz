#_N_MAIN_LINES   Domato - main generator script
#   -------------------------------
#
...
def generate_samples(grammar_dir, outfile, template, n_lines, lineguard="jscript.txt"):
...
def main():
    print(generate_samples(os.path.dirname(__file__),None,"<jsfuzzer>",1,"jscript.txt"))
