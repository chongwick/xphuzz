...
// Example usage
console.log(invalidControlGenerator.next().value); // Returns the first invalid control character
console.log(invalidControlGenerator.next().value); // Returns the next invalid control character
