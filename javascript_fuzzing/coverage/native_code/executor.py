...
class Executor:
    ...
    def backup_global_coverage_map(self):
        self.backup_edges = self.number_triggered_edges
    ...
    def restore_global_coverage_map(self):
        ...
        #print("backup: ",self.backup_edges)
        self.number_triggered_edges = self.backup_edges
    ...
    def print_statistics(self):
        ...
        if float(script_timediff.seconds) > 0:
